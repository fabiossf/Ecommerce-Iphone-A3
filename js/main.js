...
function updatetotal(){
  ...
  // Formatando o total para o formato de moeda brasileira
  var totalFormatado = total.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });

  // Atualizando o valor total formatado no HTML
  document.getElementsByClassName("total-price")[0].innerText = totalFormatado;
} 